...
class PhotonsModel extends ConcentrationModel {
  ...
  constructor( tandem ) {
    ...
    // look decent.
    this.clouds.push(
      new Cloud( new Vector2( -20000, 20000 ), 15000, 3500 ),
      { tandem: tandem.createTandem( 'cloud0' ) }
    );
    this.clouds.push(
      new Cloud( new Vector2( 5000, 32000 ), 12000, 2500 ),
      { tandem: tandem.createTandem( 'cloud1' ) }
    );
    this.clouds.push(
      new Cloud( new Vector2( 24000, 25000 ), 18000, 3000 ),
