...
const greenhouseEffectTitleStringProperty = GreenhouseEffectFluent[ 'greenhouse-effect' ].titleStringProperty;
...
const simOptions: SimOptions = {
  ...
  credits: {
    ...
    team: 'Wendy Adams, Wanda D\u00edaz Merced, Anne U. Gold, Danielle Harlow, Kelly Lancaster,<br>' +
          'Trish Loeblein, Matthew Moore, Mark Nielsen, Ariel Paul, Robert Parson, Taliesin Smith, Carl Wieman',
    qualityAssurance: 'Jaron Droder, Clifford Hardin, Amanda McGarry, Emily Miller, Nancy Salpepi,<br>Marla Schulz, ' +
                      'Luisa Vargas, Kathryn Woessner',
    graphicArts: 'Mariah Hermsmeyer',
    soundDesign: 'Ashton Morris',
    thanks: 'HHMI BioInteractive for their partnership on the inclusive design and accessibility of this simulation.<br>' +
            'Dedicated to the memory of Ron LeMaster.'
  },
