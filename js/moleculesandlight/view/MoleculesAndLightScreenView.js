...
class MoleculesAndLightScreenView extends ScreenView {
  ...
  constructor( photonAbsorptionModel, tandem ) {
    ...
    super( {
      ...
      tandem: tandem,
      screenSummaryContent: new MoleculesAndLightScreenSummaryNode( photonAbsorptionModel, observationWindow.returnMoleculeButtonVisibleProperty )
    } );
