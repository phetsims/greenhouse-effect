...
/**
 * A model element for a cloud. Clouds can interact with light, generally reflecting it in both the up and down
 * directions. The shape of the cloud is modelled as an elliptical shape that is created from the provided width, height
 * and center position.
 *
...
// constants
const REFLECTIVITY = 0.5; // This is a proportion from 0 to 1 and affects interaction with all types of light.
...
class Cloud {
  ...
  constructor( position, width, height ) {
    ...
    // reflectivity of the cloud and its width relative to the span of the incoming sunlight.
  ...
  interactWithEnergy( emEnergyPackets, dt ) {
    ...
    emEnergyPackets.forEach( energyPacket => {
      ...
      if ( this.enabledProperty.value &&
        ...
        // This energy packet has crossed through the cloud.  Reflect it.
