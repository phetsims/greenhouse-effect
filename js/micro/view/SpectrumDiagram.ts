...
const spectrumWindowFrequencyArrowLabelStringProperty = GreenhouseEffectFluent.SpectrumWindow.frequencyArrowLabelStringProperty;
const spectrumWindowGammaRayBandLabelStringProperty = GreenhouseEffectFluent.SpectrumWindow.gammaRayBandLabelStringProperty;
const spectrumWindowInfraredBandLabelStringProperty = GreenhouseEffectFluent.SpectrumWindow.infraredBandLabelStringProperty;
const spectrumWindowMetersUnitsStringProperty = GreenhouseEffectFluent.SpectrumWindow.metersUnitsStringProperty;
const spectrumWindowMicrowaveBandLabelStringProperty = GreenhouseEffectFluent.SpectrumWindow.microwaveBandLabelStringProperty;
const spectrumWindowRadioBandLabelStringProperty = GreenhouseEffectFluent.SpectrumWindow.radioBandLabelStringProperty;
const spectrumWindowTitleStringProperty = GreenhouseEffectFluent.SpectrumWindow.titleStringProperty;
const spectrumWindowUltravioletBandLabelStringProperty = GreenhouseEffectFluent.SpectrumWindow.ultravioletBandLabelStringProperty;
const spectrumWindowVisibleBandLabelStringProperty = GreenhouseEffectFluent.SpectrumWindow.visibleBandLabelStringProperty;
const spectrumWindowWavelengthArrowLabelStringProperty = GreenhouseEffectFluent.SpectrumWindow.wavelengthArrowLabelStringProperty;
const spectrumWindowXrayBandLabelStringProperty = GreenhouseEffectFluent.SpectrumWindow.xrayBandLabelStringProperty;
const spectrumWindowDescriptionMessageProperty = GreenhouseEffectFluent.a11y.micro.spectrumWindowDescriptionStringProperty;
const spectrumWindowEnergyDescriptionMessageProperty = GreenhouseEffectFluent.a11y.micro.spectrumWindowEnergyDescriptionStringProperty;
const spectrumWindowSinWaveDescriptionMessageProperty = GreenhouseEffectFluent.a11y.micro.spectrumWindowSinWaveDescriptionStringProperty;
const spectrumWindowLabelledSpectrumLabelMessageProperty = GreenhouseEffectFluent.a11y.micro.spectrumWindowLabelledSpectrumLabelStringProperty;
const spectrumWindowLabelledSpectrumDescriptionMessageProperty = GreenhouseEffectFluent.a11y.micro.spectrumWindowLabelledSpectrumDescriptionStringProperty;
const spectrumWindowLabelledSpectrumRadioLabelMessageProperty = GreenhouseEffectFluent.a11y.micro.spectrumWindowLabelledSpectrumRadioLabelStringProperty;
const spectrumWindowLabelledSpectrumMicrowaveLabelMessageProperty = GreenhouseEffectFluent.a11y.micro.spectrumWindowLabelledSpectrumMicrowaveLabelStringProperty;
const spectrumWindowLabelledSpectrumInfraredLabelMessageProperty = GreenhouseEffectFluent.a11y.micro.spectrumWindowLabelledSpectrumInfraredLabelStringProperty;
const spectrumWindowLabelledSpectrumVisibleLabelMessageProperty = GreenhouseEffectFluent.a11y.micro.spectrumWindowLabelledSpectrumVisibleLabelStringProperty;
const spectrumWindowLabelledSpectrumUltravioletLabelMessageProperty = GreenhouseEffectFluent.a11y.micro.spectrumWindowLabelledSpectrumUltravioletLabelStringProperty;
const spectrumWindowLabelledSpectrumXrayLabelMessageProperty = GreenhouseEffectFluent.a11y.micro.spectrumWindowLabelledSpectrumXrayLabelStringProperty;
const spectrumWindowLabelledSpectrumGammaRayLabelMessageProperty = GreenhouseEffectFluent.a11y.micro.spectrumWindowLabelledSpectrumGammaRayLabelStringProperty;
const spectrumWindowLabelledSpectrumRadioFrequencyDescriptionMessageProperty = GreenhouseEffectFluent.a11y.micro.spectrumWindowLabelledSpectrumRadioFrequencyDescriptionStringProperty;
const spectrumWindowLabelledSpectrumRadioWavelengthDescriptionMessageProperty = GreenhouseEffectFluent.a11y.micro.spectrumWindowLabelledSpectrumRadioWavelengthDescriptionStringProperty;
const spectrumWindowLabelledSpectrumMicrowaveFrequencyDescriptionMessageProperty = GreenhouseEffectFluent.a11y.micro.spectrumWindowLabelledSpectrumMicrowaveFrequencyDescriptionStringProperty;
const spectrumWindowLabelledSpectrumMicrowaveWavelengthDescriptionMessageProperty = GreenhouseEffectFluent.a11y.micro.spectrumWindowLabelledSpectrumMicrowaveWavelengthDescriptionStringProperty;
const spectrumWindowLabelledSpectrumInfraredFrequencyDescriptionMessageProperty = GreenhouseEffectFluent.a11y.micro.spectrumWindowLabelledSpectrumInfraredFrequencyDescriptionStringProperty;
const spectrumWindowLabelledSpectrumInfraredWavelengthDescriptionMessageProperty = GreenhouseEffectFluent.a11y.micro.spectrumWindowLabelledSpectrumInfraredWavelengthDescriptionStringProperty;
const spectrumWindowLabelledSpectrumVisibleFrequencyDescriptionMessageProperty = GreenhouseEffectFluent.a11y.micro.spectrumWindowLabelledSpectrumVisibleFrequencyDescriptionStringProperty;
const spectrumWindowLabelledSpectrumVisibleWavelengthDescriptionMessageProperty = GreenhouseEffectFluent.a11y.micro.spectrumWindowLabelledSpectrumVisibleWavelengthDescriptionStringProperty;
const spectrumWindowLabelledSpectrumVisibleGraphicalDescriptionMessageProperty = GreenhouseEffectFluent.a11y.micro.spectrumWindowLabelledSpectrumVisibleGraphicalDescriptionStringProperty;
const spectrumWindowLabelledSpectrumUltravioletFrequencyDescriptionMessageProperty = GreenhouseEffectFluent.a11y.micro.spectrumWindowLabelledSpectrumUltravioletFrequencyDescriptionStringProperty;
const spectrumWindowLabelledSpectrumUltravioletWavelengthDescriptionMessageProperty = GreenhouseEffectFluent.a11y.micro.spectrumWindowLabelledSpectrumUltravioletWavelengthDescriptionStringProperty;
const spectrumWindowLabelledSpectrumXrayFrequencyDescriptionMessageProperty = GreenhouseEffectFluent.a11y.micro.spectrumWindowLabelledSpectrumXrayFrequencyDescriptionStringProperty;
const spectrumWindowLabelledSpectrumXrayWavelengthDescriptionMessageProperty = GreenhouseEffectFluent.a11y.micro.spectrumWindowLabelledSpectrumXrayWavelengthDescriptionStringProperty;
const spectrumWindowLabelledSpectrumGammaRayFrequencyDescriptionMessageProperty = GreenhouseEffectFluent.a11y.micro.spectrumWindowLabelledSpectrumGammaRayFrequencyDescriptionStringProperty;
const spectrumWindowLabelledSpectrumGammaRayWavelengthDescriptionMessageProperty = GreenhouseEffectFluent.a11y.micro.spectrumWindowLabelledSpectrumGammaRayWavelengthDescriptionStringProperty;
